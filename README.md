...
draft <-dplyr::select(draft, -c(all_of(drops)))
```
...
![](Draft-Pick-Value-HTML_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
![](Draft-Pick-Value-HTML_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
